...
import argparse
import zipfile
from cvss.utils import check_sha1, download, mkdir

_TARGET_DIR = os.path.expanduser('~/.cvss/data')

def parse_args():
    parser = argparse.ArgumentParser(
        description='Initialize CITYSCAPES dataset.',
...
if __name__ == '__main__':
    args = parse_args()
    mkdir(os.path.expanduser('~/.cvss/data'))

...
from cvss.nn import SegmentationMultiLosses, SegmentationLosses
from cvss.ops import DistSyncBatchNorm

from cvss.datasets import get_dataset
from cvss.models import get_segmentation_model
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # criterions
    if args.model == 'danet': 
        criterion = SegmentationMultiLosses(nclass=nclass)
    else: 
